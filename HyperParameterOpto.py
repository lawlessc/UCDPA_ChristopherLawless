...
class HyperParameterOpto:
    ...
    def train_network(self, data):
        ...
        optimizer_list = [opto_ssg3]  # ,"adam",my_optimizer3,"sgd",my_optimizer4,my_optimizer5,
        # my_optimizer6,
            ...
            for batch_size in batch_sizes:
                for layers in hidden_layers:
                    for widths in hidden_layer_widths:
                        ...
                        model = self.neuralnet_d.create_model()

                        #model = self.neuralnet_d.compile_model(model, optimizer)
                        history, model = self.neuralnet_d.fit_model(data=data, epochs=150, model=model,
